...
const Home = () => {
  ...
  const { displayVideos, recentVideos, remainingVideos } = useMemo(() => {
    ...
    const remainingVideos = videos.slice(20);
    const recentVideos = sortedByDate.slice(0, 8);

    return { displayVideos, recentVideos, remainingVideos };
